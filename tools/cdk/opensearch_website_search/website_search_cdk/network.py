...
class Network(cdk.Stack):
    ...
    def __init__(self, scope: cdk.Construct, construct_id: str, **kwargs) -> None:
        ...
        self.security_group = ec2.SecurityGroup(self, STACK_PREFIX + "cdk-security-group",
                                                vpc=self.vpc, description="Opensearch website search domain security group",
        ...
        # self.security_group.add_ingress_rule(prefixList, ec2.Port.tcp(9300),
        #                                      description="Transport port for cluster formation")
        # self.security_group.add_ingress_rule(prefixList, ec2.Port.tcp(9200), description="OpenSearch runs on port 9200")
        # self.security_group.add_ingress_rule(prefixList, ec2.Port.tcp(9600),
        #                                      description="Performance Analyzer plugin port")
        # self.security_group.add_ingress_rule(prefixList, ec2.Port.tcp(5601),
        #                                      description="Used for accessing OpenSearch Dashboards")
        ...
        # self.security_group.add_ingress_rule(ec2.Peer.ipv4(self.vpc.vpc_cidr_block), ec2.Port.tcp(22), description="SSH access to the nodes from VPC")
        # self.security_group.add_ingress_rule(cidr, ec2.Port.tcp(9300),
        #                                      description="Transport port for cluster formation from VPC")
        self.security_group.add_ingress_rule(ec2.Peer.ipv4(self.vpc.vpc_cidr_block), ec2.Port.tcp(9200), description="OpenSearch runs on port 9200 from VPC")
        ...
        self.security_group.add_ingress_rule(ec2.Peer.any_ipv4(), ec2.Port.tcp(9200), description="OpenSearch runs on port 9200 from VPC")
        self.security_group.add_ingress_rule(ec2.Peer.any_ipv4(), ec2.Port.tcp(9600),
                                             description="Performance Analyzer plugin port from VPC")
        self.security_group.add_ingress_rule(ec2.Peer.any_ipv4(), ec2.Port.tcp(5601),
                                             description="Used for accessing OpenSearch Dashboards from VPC")